...
<PlantUML file="c4-example.puml" alt="Rendered C4 container diagram: a customer uses the web application, which calls the API application, which reads from and writes to the PostgreSQL database" />
